...
class CreateSettlementReconciliationActsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('SettlementReconciliationActs', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('SettlementReconciliationActs');
    }
}
