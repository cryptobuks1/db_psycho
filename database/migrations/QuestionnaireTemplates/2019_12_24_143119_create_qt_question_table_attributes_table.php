...
class CreateQtQuestionTableAttributesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('QTQuestionTableAttributes', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('qt_question_table_id')->nullable();
    ...
    {
        Schema::dropIfExists('QTQuestionTableAttributes');
    }
}
