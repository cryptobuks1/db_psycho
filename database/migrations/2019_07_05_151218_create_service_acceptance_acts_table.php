...
class CreateServiceAcceptanceActsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ServiceAcceptanceActs', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('ServiceAcceptanceActs');
    }
}
