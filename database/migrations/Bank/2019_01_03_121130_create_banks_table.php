...
class CreateBanksTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('_Banks', function (Blueprint $table) {
            ...
            $table->string('bank_name_en', 200)->nullable();
            $table->string('registry_number', 20)->nullable();
            $table->string('bank_swift_code', 20)->nullable()->unique();
            $table->string('bank_nation_code', 9)->nullable();
            $table->string('bank_corr_account', 50)->nullable();
