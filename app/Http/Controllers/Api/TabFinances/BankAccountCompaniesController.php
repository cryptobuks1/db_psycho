...
class BankAccountCompaniesController extends Controller
{
        ...
        $list = [
            ...
            "dependent" => [
                ...
                "dependent_fields" => [
                    ...
                    "current_value"=>$Companies[0]['company_short_name'],// todo: сюда подставишь, что тебе надо, если тип 'select' - в этом поле нет нужды
                    "options_data" => [
    ...
    public function card(Request $request){
        ...
        $BankAccount = BankAccount::where('table_n', $model)
            ->with('bank', 'bankAccountType', 'currency')
            ->leftjoin('Companies', 'BankAccounts.row_id', '=', 'Companies.id')
...
//        dd($BankAccount);
        ...
        foreach ($BankAccount as $bankColumn){
            ...
            $BankAccounts[]=[
                ...
                'bank_id'=> $bankColumn['bank_id'],
                'bank_name'=> $bankColumn['bank_name'],
                'company_short_name'=> $bankColumn['company_short_name'],
                'currency_id'=> $bankColumn['currency_id'],
                'currency_name'=> $bankColumn['currency_name'],
                'bank_account_type_id'=> $bankColumn['bank_account_type_id'],
                'bank_account_type_name'=> $bankColumn['bank_account_type_name'],
        ...
        foreach ($methods as $key=>$value) {
            if (isset($value) and ($value == "read") ){
                $card =[
                    ...
                    "actions" => [
                        "actions_card" => [
//                            ["title" => $getArrayCaptions['ok']['translation_captions']['caption_translation'], "code" => "save", "class" => "btn btn-green", "link" => "/admin/company/bankAccounts/update", "img" => ""],
//                            ["title" => $getArrayCaptions['apply']['translation_captions']['caption_translation'], "code" => "apply", "class" => "btn btn-green", "link" => "/admin/company/bankAccounts/update", "img" => ""],
                                    ...
                                    "block_fields" => [
                                        ...
                                        [
                                            ...
                                            "options_data" => [
                                                ...
                                                "options_field_id" => "bank_account_type_id",
            ...
            if (isset($value) and  (($value == "update")) ){
                $card =[
                    ...
                    "form_parameters" => [
                            ...
                            "form_type_list" => [
                                "form_card_url" => "/bankAccounts",
                                "form_search_field" => "bank_account_name",
                        ],
                    ],
                    "dependent" => [
                        "dependent_data_model" => "BankAccounts",
