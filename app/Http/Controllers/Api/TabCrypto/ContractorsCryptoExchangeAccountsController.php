...
class ContractorsCryptoExchangeAccountsController extends Controller
{
    public function list(Request $request) {
        ...
        $CryptoAccount = CryptoAccount::where('table_n', $model)
            ...
            ->select('_CryptoExchanges.*',  'Contractors.*', 'CryptoAccounts.*')
    ...
    public function card(Request $request){
        ...
        foreach ($CryptoAccounts as $cryptoColumn){
            $cryptoColumn['c_exchange_name1'] =  $cryptoColumn['c_exchange_name']. "-". $cryptoColumn['c_exchange_url'];
            ...
            $CryptoAccount[]=[
                ...
                'c_exchange_name'=> $cryptoColumn['c_exchange_name'],
                'c_exchange_name1'=> $cryptoColumn['c_exchange_name1'],
                'c_exchange_url'=> $cryptoColumn['c_exchange_url'],
        ...
        $CryptoExchange = CryptoExchange::get()->toArray();

        $exchangesColumnArray=[];
        $CryptoExchanges=[];
        foreach ($CryptoExchange as $tokenExchange){
            $tokenExchange['c_exchange_name1'] =  $tokenExchange['c_exchange_name']. "-". $tokenExchange['c_exchange_url'];
            $exchangesColumnArray[]= $tokenExchange;

            $CryptoExchanges[]=[
                'id'=> $tokenExchange['id'],
                'c_exchange_name1'=> $tokenExchange['c_exchange_name1'],
                'c_exchange_name'=> $tokenExchange['c_exchange_name'],
                'c_exchange_url'=> $tokenExchange['c_exchange_url'],
            ];
        }
        ...
        foreach ($methods as $key=>$value){
            ...
            if (isset($value) and  (($value == "update")) ){
                $card =[
                    ...
                    "actions" => [
                        "actions_card" => [
                            ["title" => $getArrayCaptions['ok']['translation_captions']['caption_translation'], "code" => "save", "class" => "btn btn-green", "link" => "/admin/contractor/cryptoExchangeAccounts/update", "img" => ""],
                            ["title" => $getArrayCaptions['apply']['translation_captions']['caption_translation'], "code" => "apply", "class" => "btn btn-green", "link" => "/admin/contractor/cryptoExchangeAccounts/update", "img" => ""],
                            ["title" => $getArrayCaptions['back']['translation_captions']['caption_translation'], "code" => "back", "class" => "btn btn-grey", "link" => "", "img" => ""],
                        ]
                    ],
                    "tabs" => [
                                    ...
                                    "block_fields" => [
                                        ...
                                        [
                                            ...
                                            "options_data" => [
                                                ...
                                                "options_field_id" => "id",
                                                "options_field_title" => "c_exchange_name1",
                                                "search" =>""
                                            ],
                                            "zone" => "1",
                                            "order" => "2"
