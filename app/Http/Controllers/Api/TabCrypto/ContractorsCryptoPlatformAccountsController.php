...
class ContractorsCryptoPlatformAccountsController extends Controller
{
    public function list(Request $request) {
        ...
        $captionName = [
            ...
            'CryptoAccountName', 'CryptoExchange', 'CryptoExchangeAccounts', 'CryptoPlatformAccounts',
        ...
        $CryptoAccount = CryptoAccount::where('table_n', $model)
            ...
            ->select('_CryptoPlatforms.*',  'Contractors.*', 'CryptoAccounts.*')
        ...
        $list = [
            ...
            "form_parameters" => [
                "form_title" => $getArrayCaptions['CryptoPlatformAccounts']['translation_captions']['caption_translation'],
                ...
                "form_type_list" => [
                    "form_card_url" => "/cryptoPlatformAccounts/",
    ...
    public function card(Request $request){
        ...
        $captionName = [
            'ok', 'apply', 'back', 'Main',
            'Remark','Image', 'Country', 'SystemDetails', 'Actual',
            'CryptoAccounts', 'Code', 'Name', 'CryptoAccount', 'CryptoAccountHolder', 'CryptoWallets',
            'ExternalService', 'HolderCryptoExchangeAccount', 'CryptoAccountLogin', 'CryptoAccountPassword',
        ...
        foreach ($methods as $key=>$value){
            if (isset($value) and ($value == "read") ){
                $card =[
                    ...
                    "links" => [
                        [
                            "link_title" =>  $getArrayCaptions['CryptoWallets']['translation_captions']['caption_translation'],
                            "link_img" => "",
                            "link_type" =>"internal_push",
                            "link_url" => "/cryptoPlatformWallets"
                        ]
                    ],
                    "actions" => [
                        "actions_card" => [
            ...
            if (isset($value) and  (($value == "update")) ){
                $card =[
                    ...
                    "actions" => [
                        "actions_card" => [
                            ["title" => $getArrayCaptions['ok']['translation_captions']['caption_translation'], "code" => "save", "class" => "btn btn-green", "link" => "/admin/contractor/cryptoPlatformAccounts/update", "img" => ""],
                            ["title" => $getArrayCaptions['apply']['translation_captions']['caption_translation'], "code" => "apply", "class" => "btn btn-green", "link" => "/admin/contractor/cryptoPlatformAccounts/update", "img" => ""],
                            ["title" => $getArrayCaptions['back']['translation_captions']['caption_translation'], "code" => "back", "class" => "btn btn-grey", "link" => "", "img" => ""],
                        ]
                    ],
                    "tabs" => [
