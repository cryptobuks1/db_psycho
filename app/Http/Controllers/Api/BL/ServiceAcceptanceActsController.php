...
class ServiceAcceptanceActsController extends Controller
{
    public function list_query()
    {
        return ServiceAcceptanceAct::with("contractorContract", "contractorContract.contractor:id,contractor_short_name")
    ...
    public function list(Request $request)
    {
        ...
        $list = [
            ...
            "form_parameters"  => [
                "form_title"                    => $getArrayCaptions['AcceptanceActs']['translation_captions']['caption_translation'],
    ...
    public function requestCard(Request $request)
    {
        ...
        $tabs = [
            [
                ...
                "blocks"           => [
                    [
                        "block_title"         => $getArrayCaptions['RequestAcceptanceActs']['translation_captions']['caption_translation'],
        ...
        $res = [
            [
                ...
                //$contract->id,
                "document_kind"          => $getArrayCaptions['AcceptanceAct']['translation_captions']['caption_translation']
            ]
        ];
        ...
        $card = [
            ...
            "form_parameters" => [
                ...
                "form_base_data_model"          => $main_model,
                "form_main_data_model_id_field" => "id",
                "form_main_data_model_name"     => $getArrayCaptions['RequestAcceptanceActs']['translation_captions']['caption_translation'],
            ],
    ...
    public function getDocuments(Request $request)
    {
        ...
        $array_to_send = [
            "request" => [
                ...
                "request_parameters" => [
                    "document_type"           => "service_acceptance_acts",
