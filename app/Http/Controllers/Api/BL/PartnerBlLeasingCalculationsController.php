...
class PartnerBlLeasingCalculationsController extends BlLeasingCalculationsController
{
    public function list_query($customerRequestArrayId){
        return parent::list_query($customerRequestArrayId)->has('blCustomerRequest.partnerPoint.partnerRegions')->has('blCustomerRequest.partnerPoint.partner');
    }

    public function card_query($leasingCalculationId, $customerRequestArrayId){
        return parent::card_query($leasingCalculationId, $customerRequestArrayId)->has('blCustomerRequest.partnerPoint.partnerRegions')->has('blCustomerRequest.partnerPoint.partner');
    }
