...
class InvoicesController extends Controller
{
    public function list_query(){
        return Invoice::with("contractorContract",
            "contractorContract.contractor:id,contractor_short_name")->has("contractorContract");
    }
    ...
    public function list(Request $request)
    {
        ...
        $captionName = ["Number", "Date", "Contract", "Contractor", "Sum", "AcceptanceActs", "LeasingPaymentAccounts", "ReconciliationRecords",
                        "PeriodFrom", "PeriodBy", "PrintedForm", "FAQGraphicsDocumentation", "Invoices"];
        $getArrayCaptions = $this->getTranslateByKeys($captionName);

        $main_model = \App\Models\Controller::where('controller_code',
            class_basename(Route::current()->controller))->value('controller_alias');
        ...
        $list = [
            ...
            "form_parameters"  => [
                "form_title"                    => $getArrayCaptions['Invoices']['translation_captions']['caption_translation'],
                    ...
                    "blocks"          => [
                        [
                            ...
                            "block_fields"        => [
                                ...
                                ['key'   => "doc_sum", 'sortable' => true, 'class' => '', 'thStyle' => 'width: 15%',
                                 'label' => $getArrayCaptions['Sum']['translation_captions']['caption_translation'], "filter" => true],
    ...
    {
        $captionName = ["DocumentKind", "Cancel", "Contract", "Contractor", "Sum",
                        "OverEntirePeriod", "RequestInvoices",
                        "Invoice", "new",
...
//        }
        ...
        $contracts = ContractorContract::select('id', 'contractor_contract_name as contract', 'contractor_id')->with(array("contractor" => function($query)
        {
        ...
        $tabs = [
            [
                ...
                "blocks"           => [
                    [
                        "block_title"         => $getArrayCaptions['RequestInvoices']['translation_captions']['caption_translation'],
                        "block_zone_quantity" => 2,
                        "block_model"         => $main_model,
                        "block_type"          => "block_card",
                        "block_fields"        => [
                            ['title' => $getArrayCaptions['Period']['translation_captions']['caption_translation'], 'width' => '100%',
                             'model_name'=>$main_model,'model' => '', 'type' => 'title', "zone" => "1", "order" => "1", "border_right" => false],
                            ['title' => $getArrayCaptions["EnterPeriod"]['translation_captions']['caption_translation'], 'model_name'=>$main_model,'model' => 'date',
                             'type'  => 'double-date', 'width' => '50%', "zone" => "1", "order" => "2", "border_right" => false],
                            ['title' => $getArrayCaptions["OverEntirePeriod"]['translation_captions']['caption_translation'], 'model_name'=>$main_model,'model' => 'entire_period',
                             'type'  => 'checkbox', 'width' => '30%', "zone" => "1", "order" => "3", "border_right" => false],
//                            ['title' => $getArrayCaptions['Contract']['translation_captions']['caption_translation'], 'width' => '100%',
//                                'model_name'=>$main_model,'model' => 'contract', 'type' => 'label', "zone" => "1", "order" => "4", "border_right" => false],
                            ['title' => $getArrayCaptions['Contract']['translation_captions']['caption_translation'],
                                'model_name'=>$main_model,'model' => 'contractor_contract_id',
                                'type' => 'vue-select',
                                'width' => '100%',
                                'options' => [],
                                "options_data" => [
                            ...
                            ['title' => $getArrayCaptions['RequestParameters']['translation_captions']['caption_translation'], 'width' => '100%',
                             'model_name'=>$main_model,'model' => '', 'type' => 'title', "zone" => "2", "order" => "5", "border_right" => false],
                            ['title' => $getArrayCaptions['Contractor']['translation_captions']['caption_translation'], 'width' => '100%',
                             'model_name'=>$main_model,'model' => 'contractor_name', 'type' => 'label', "zone" => "2", "order" => "6", "border_right" => false],
                            ['title' => $getArrayCaptions['DocumentKind']['translation_captions']['caption_translation'], 'width' => '100%',
                             'model_name'=>$main_model,'model' => 'document_kind', 'type' => 'label', "zone" => "2", "order" => "7", "border_right" => false],
                        ]
                    ],
                ]
            ],
        ...
        $res = [[ //Итоговый массив рекизитов
            ...
            "entire_period"          => false,
            "contractor_name"        => count( $contracts) == 1 ? $contracts[0]['contractor']['contractor_short_name']??'' : '',//$contract->contractor->contractor_short_name,
            "contract"               => count( $contracts) == 1 ? $contracts[0]['contract'] : '',//$contract->contractor_contract_name,
            "contractor_contract_id" => count( $contracts) == 1 ? $contracts[0]['id'] : null,//$contract->id,
            "document_kind"          => $getArrayCaptions['Invoice']['translation_captions']['caption_translation']
        ]];
        ...
        $card = [
            ...
            "form_parameters" => [
                ...
                "form_base_data_model"          => $main_model,
                "form_main_data_model_id_field" => "id",
                "form_main_data_model_name"     => $getArrayCaptions['RequestInvoices']['translation_captions']['caption_translation'],
            ],
