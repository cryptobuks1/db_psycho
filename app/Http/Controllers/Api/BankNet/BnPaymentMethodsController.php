...
class BnPaymentMethodsController extends Controller
{
    ...
    {
        $this->list_model = BnPaymentMethod::query();
    ...
    protected function cardQuery()
    {
        ...
        $this->setIsNewObject($payment_method_id === "new");
        ...
        if($this->isNewObject())
        {
            ...
            $this->card_model = [BnPaymentMethod::getNewObject()];
        }
        else
        {
            $this->card_model = BnPaymentMethod::query()->where('id', $payment_method_id);
    ...
    public function setCardBlockFields(): self
    {
        $this->card_block_fields = [
            [
                ...
                "blocks"          => [
                    [
                        "block_title"         => $this->getTranslatedCardCaption("PaymentMethod"),
    ...
    {
        $this->card_form_title = "PaymentMethod";
    ...
    {
        $this->card_main_data_model_name = ($this->isNewObject()) ? $this->getTranslatedCardCaption("new") : $this->card_model[0]["payment_method_name"];
